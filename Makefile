...
CONFIG_CLEAN_FILES = doxygen/Doxyfile utils/subfiling_vfd/h5fuse.sh
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(top_srcdir)/bin/compile \
	...
	$(top_srcdir)/utils/subfiling_vfd/h5fuse.sh.in COPYING
...
ACLOCAL = ${SHELL} /data4/home/krunalmistry/hdf5-hdf5-1_14_3/bin/missing aclocal-1.16
...
AM_CPPFLAGS =  -D_GNU_SOURCE -D_POSIX_C_SOURCE=200809L   -DNDEBUG -UH5_DEBUG_API -I/data4/home/krunalmistry/hdf5-hdf5-1_14_3/src/H5FDsubfiling
...
AR_FLAGS = cr
ASSERTS = no
AUTOCONF = ${SHELL} /data4/home/krunalmistry/hdf5-hdf5-1_14_3/bin/missing autoconf
AUTOHEADER = ${SHELL} /data4/home/krunalmistry/hdf5-hdf5-1_14_3/bin/missing autoheader
AUTOMAKE = ${SHELL} /data4/home/krunalmistry/hdf5-hdf5-1_14_3/bin/missing automake-1.16
AWK = mawk
...
CODESTACK = no
CONFIG_DATE = Mon Jun 23 02:33:07 IST 2025
CONFIG_MODE = 
CONFIG_USER = krunalmistry@Amazon-GPU
CPPFLAGS = 
CXX = no
CXXCPP = g++ -E
...
JAVA_JUNIT = 
JAVA_PATH_NAME = 
JAVA_VERSION = /data4/home/krunalmistry/AFL/ (./configure: line 34430: -version: command not found)
JNIFLAGS = 
JNI_LDFLAGS = 
JUNIT = 
...
LIPO = 
LL_PATH = /data4/home/krunalmistry/.local/lib:/data4/home/krunalmistry/.local/lib:/data4/home/krunalmistry/openmpi/lib:/data4/home/krunalmistry/.local/lib:/data4/home/krunalmistry/.local/lib:/data4/home/krunalmistry/openmpi/lib::
LN_S = ln -s
LTLIBOBJS = 
LT_STATIC_EXEC = 
LT_SYS_LIBRARY_PATH = 
MAINT = #
MAKEINFO = ${SHELL} /data4/home/krunalmistry/hdf5-hdf5-1_14_3/bin/missing makeinfo
MANIFEST_TOOL = :
MAP_API = no
MIRROR_VFD = no
...
PROFILING = no
RANLIB = ranlib
ROOT = /data4/home/krunalmistry/hdf5-hdf5-1_14_3
ROS3_VFD = no
RUNPARALLEL = 
RUNSERIAL = 
R_INTEGER = 
...
TR = /usr/bin/tr
TRACE_API = no
UNAME_INFO = Linux Amazon-GPU 6.8.0-59-generic #61~22.04.1-Ubuntu SMP PREEMPT_DYNAMIC Tue Apr 15 17:03:15 UTC 2 x86_64 x86_64 x86_64 GNU/Linux
USE_FILE_LOCKING = 
...
WORDS_BIGENDIAN = no
_ACJNI_JAVAC = 
abs_builddir = /data4/home/krunalmistry/hdf5-hdf5-1_14_3
abs_srcdir = /data4/home/krunalmistry/hdf5-hdf5-1_14_3
abs_top_builddir = /data4/home/krunalmistry/hdf5-hdf5-1_14_3
abs_top_srcdir = /data4/home/krunalmistry/hdf5-hdf5-1_14_3
ac_ct_AR = 
ac_ct_CC = gcc
ac_ct_CXX = 
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /data4/home/krunalmistry/hdf5-hdf5-1_14_3/bin/install-sh
...
utils/subfiling_vfd/h5fuse.sh: $(top_builddir)/config.status $(top_srcdir)/utils/subfiling_vfd/h5fuse.sh.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
